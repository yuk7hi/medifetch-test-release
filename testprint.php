    ...
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="collapse_target">
            <ul class="navbar-nav mr-auto">
                ...
                <li>
                    <div style="margin-left:700px;" class="subscribe_container">
                        <form class="form-inline" target="_blank" action="user_subscribe.php" method="post">
                        <div >
                            <input type="number" name="telno" class="form-control" id="tel">
                        </div>
                        <button  style="margin-left:10px;"  id="nsubmit" class="btn btn-info" type="submit">Subscribe to get Confirmation from Nearest Pharmacy</button>
                        </form>
                    </div>
                </li>               
            </ul>
